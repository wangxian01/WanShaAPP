package com.example.l.wanshaapp.Rankingbean;

/**
 * Created by 侯顺发 on 2018/5/24.
 */

public class RankingFragemntBean {


    /**
     * game_name : 火花人生
     * game_introduction : 爆竹的生活并不容易!","探索无尽的沙漠","为了王室而战","一款星光闪闪的速度游戏
     * publisher : 傻逼公司
     * games_icon : R.drawable.rankinghot_01
     * score_icon : R.drawable.errostar
     * game_type1 : 益智
     * game_type2 : 解密
     * game_type3 : null
     * game_type4 : null
     ...
     * games_downloadurl : http://shouji.360tpcdn.com/180123/3e2ca8de45d69f9d0ef4bd01e0f96357/h.h.r.s.sparklife.other_1.apk
     */
    ...
    public void setGames_icon(String games_icon) {
        this.games_icon = games_icon;
    }
    ...
    public void setScore_icon(String score_icon) {
    ...
    public void setGame_type3(Object game_type3) {
        this.game_type3= (String) game_type3;
    }
    ...
    public void setGame_type4(Object game_type4) {
        this.game_type4 = (String) game_type4;
    }
